  ...
  return (
    <TabsContent value='skills' className='w-full h-full'>
      <div className="flex flex-col gap-[30px]">
        ...
        <div className='flex items-center justify-center xl:justify-start'>
          <h4 className='text-2xl font-bold capitalize'>tecnologias monitoreo</h4>
        </div>
        <ul className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:gap-[30px] gap-4'>
          {skills.techMn.map((skill, index) => {
            return (
              <li key={index}>
                <div className='w-full h-[150px] bg-[#232329] rounded-xl flex flex-col justify-center items-center group'>
                  <p className='capitalize group-hover:text-accent'>{skill.name}</p>
        ...
        <div className='flex items-center justify-center xl:justify-start'>
          <h4 className='text-2xl font-bold capitalize'>tecnologias DevOps</h4>
        </div>
        <ul className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:gap-[30px] gap-4'>
          {skills.techDo.map((skill, index) => {
            return (
              <li key={index}>
                <div className='w-full h-[150px] bg-[#232329] rounded-xl flex flex-col justify-center items-center group'>
                  <p className='capitalize group-hover:text-accent'>{skill.name}</p>
